...
bool ECO::update(const cv::Mat &frame, cv::Rect2f &roi)
{
	...
	ROS_INFO("eco Model update begin");
	//**************************************************************************
	//*****                     Model update
	//**************************************************************************
...
*/
	...
	ROS_INFO("eco train_tracker begin");
	if (train_tracker)
	{
		...
		ROS_INFO("sample_energy_.train_filter end");						  
#endif
		frames_since_last_train_ = 0;
	}
	else
	...
	//*****                       Visualization
	//**************************************************************************
	ROS_INFO("eco Visualization begin");
	if (params_.debug == 1)
	{
	...
	ROS_INFO("eco Visualization end");
	//**************************************************************************
	//*****                    			Return
	//**************************************************************************
