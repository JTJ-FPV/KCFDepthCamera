...
public:// Draw Data and Write Information Functions
	...
	void drawFLED(Mat ImgG, const  string& savepath, const string& windowsName);
	void drawFLED(Mat ImgG, Mat& ImgT, const  string& savepath, const string& windowsName);
	void drawFLED(Mat ImgG, Mat& ImgT, bool &sign, const  string& savepath, const string& windowsName);
	void drawFLED(Mat ImgG, Mat& ImgT, vector<geometry_msgs::Point> &center,bool &sign, const  string& savepath, const string& windowsName);
	bool detEllipsesSize();
...
public: // The public functions that used for Python.
	...
	int getdROWS(){return dROWS;}
	int getdCOLS(){return dCOLS;}
	int getiROWS(){return iROWS;}
	int getiCOLS(){return iCOLS;}
protected:
