...
const int MINIMUM_POINTS = 1; const double EPSILON = 50;
const int MINIMUM_POINTS_1D = 10; const double EPSILON_1D = 0.015 * 0.015; 
const int MINIMUM_POINTS_2D = 10; const double EPSILON_2D = 10 * 10;//0.0007 * 0.0007;
int main(int argc, char **argv)
{
    ...
    CADC::DepthCamera cam(&nh, aam, tra, d, d_1, d_2, 10, 0.08,0.03096, 0);
    ROS_INFO("main after");
    ros::spin();
    return 0;
}
